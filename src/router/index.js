...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'demands/lease-publish',
        name: 'LeasePublishDemands',
        component: () => import('../views/user-center/LeasePublishDemands.vue')
      },
      {
        path: 'demands/lease-request',
        name: 'LeaseRequestDemands',
        component: () => import('../views/user-center/LeaseRequestDemands.vue')
      },
      {
