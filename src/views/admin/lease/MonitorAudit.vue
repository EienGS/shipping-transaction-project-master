  ...
  <div class="monitor-audit-container">
    ...
    <div v-if="!selectedApplication" class="audit-list-view">
          ...
          <div class="search-form">
            <el-row :gutter="16" align="middle">
              <el-col :xs="24" :sm="12" :md="6">
                <el-input v-model="searchParams.keyword" placeholder="申请编号/企业名称/船舶名称" clearable
                  @keyup.enter="handleSearch" />
              </el-col>
              <el-col :xs="24" :sm="12" :md="6">
                <el-select v-model="searchParams.status" placeholder="审核状态" clearable @change="handleSearch">
      ...
      <el-card class="table-card">
        <el-table :data="paginatedApplications" style="width: 100%" :border="true" stripe
        ...
        <div class="pagination-wrapper">
          <el-pagination v-model:current-page="currentPage" v-model:page-size="pageSize" :page-sizes="[10, 20, 50, 100]"
            :total="filteredApplications.length" layout="total, sizes, prev, pager, next, jumper"
    ...
    <div v-else class="audit-detail-view">
      ...
      <el-tabs v-model="activeTab">
          ...
          <el-card>
            ...
            <el-descriptions :column="2" border>
              ...
              <el-descriptions-item label="申请监测期限" :span="2">
                {{ formatDate(selectedApplication.monitorStartDate) }} 至 {{
                  formatDate(selectedApplication.monitorEndDate)
                }}
              </el-descriptions-item>
        ...
        <el-tab-pane label="审核记录" name="history">
          <el-card>
            <el-timeline>
              <el-timeline-item v-for="record in selectedApplication.auditHistory" :key="record.time"
                :timestamp="formatDate(record.time)" placement="top">
                <el-card>
                  <h4>{{ record.action }}</h4>
    ...
    <el-dialog v-model="approveDialogVisible" title="审核通过" width="600px">
      <el-form :model="approveForm" label-width="120px">
        ...
        <el-form-item label="备注">
          <el-input v-model="approveForm.remarks" type="textarea" :rows="3" placeholder="请输入备注信息（选填）" />
        </el-form-item>
      </el-form>
      <template #footer>
