                    ...
                    <div class="menu-items">
                        <template v-for="item in group.items" :key="item.path || item.label">
                            ...
                            <div v-else class="menu-item-group">
                                <div class="menu-item menu-item-parent" :class="{ active: isItemGroupActive(item) }"
                                    @click="toggleItemGroup(item.label)">
                                    <span class="item-label">{{ item.label }}</span>
                                    <span class="expand-icon" :class="{ expanded: expandedGroups[item.label] }">›</span>
                                </div>
                                <div class="menu-submenu" v-show="expandedGroups[item.label]">
                                    <router-link v-for="subitem in item.children" :key="subitem.path" :to="subitem.path"
                                        class="menu-item menu-item-sub" :class="{ active: isActive(subitem.path) }">
