      ...
      <div class="main-content">
        ...
        <section class="header-section">
          <div class="title-row">
            <h1 class="demand-title">
              <span class="type-badge">建造需求</span>
              {{ demand.title }}
            </h1>
            <div class="actions">
        ...
        <section class="details-section">
          ...
          <div class="params-grid">
            ...
            <div class="param-item">
              <span class="param-label">建造吨位（DWT）</span>
        ...
        <section class="power-system-section">
          <h2>动力系统配置要求</h2>
          <div class="power-system-content">{{ demand.powerSystem }}</div>
        </section>
...
const getBuildDemand = (id) => {
  ...
  return demands[id] || demands['3']
}

const demand = ref(getBuildDemand(demandId))
