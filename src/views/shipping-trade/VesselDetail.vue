      ...
      <div class="main-content">
              ...
              <button class="icon-btn" :class="{ favorited: isFavorited }" @click="toggleFavorite">
                <svg viewBox="0 0 24 24" fill="none">
                  <path
                    ...
                    :stroke="isFavorited ? '#1890FF' : 'currentColor'" :fill="isFavorited ? '#1890FF' : 'none'"
                    stroke-width="2" />
                </svg>
                收藏
              </button>
        ...
        <section class="parameters-section">
          ...
          <div class="params-grid">
            <div v-for="param in vesselParameters" :key="param.label" class="param-item">
              ...
              <span v-else class="param-value" :class="{ linkable: param.linkable }"
                @click="param.linkable && searchByParam(param.key, param.value)">
                {{ param.value }}
              </span>
            </div>
          </div>
        ...
        <section class="photos-section">
          ...
          <div class="photo-indicators">
            <span v-for="(photo, index) in photos" :key="index" class="indicator"
              :class="{ active: index === currentPhotoIndex }" @click="currentPhotoIndex = index"></span>
          </div>
        </section>
      ...
      <aside class="sidebar">
        ...
        <section class="publisher-section">
          ...
          <div class="publisher-card">
            ...
            <div v-if="!isOwnVessel">
              <button v-if="intentionStatus === null" class="contact-publisher-btn" @click="handleContactPublisher">
                意向对接
              </button>
              <button v-else-if="intentionStatus === 'pending'" class="contact-publisher-btn waiting" disabled>
                等待回应中
              </button>
              <button v-else-if="intentionStatus === 'rejected'" class="contact-publisher-btn"
        ...
        <section class="other-vessels-section">
          ...
          <div class="other-vessels-list">
            <div v-for="vessel in publisherOtherVessels" :key="vessel.id" class="other-vessel-item"
              @click="goToDetail(vessel.id)">
