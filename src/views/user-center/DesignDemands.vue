        ...
        <div v-for="demand in filteredDemands" :key="demand.id" class="demand-card">
          ...
          <div class="card-content" @click="viewDetail(demand.id)">
            ...
            <div class="demand-info">
              ...
              <div class="info-row">
                <span class="info-label">设计吨位：</span>
                <span class="info-value">{{ demand.designTonnage }} DWT</span>
              </div>
              <div class="info-row">
                <span class="info-label">航区要求：</span>
                <span class="info-value">{{ getNavigationLabel(demand.navigationArea) }}</span>
              </div>
              <div class="info-row">
      ...
      <div class="modal-content large">
        ...
        <div class="modal-body-wrapper">
          <form @submit.prevent="saveEdit" class="modal-form">
            ...
            <!-- 设计需求 -->
            <div class="form-section">
              <h3 class="section-title">设计需求</h3>
              
              <div class="form-row">
                <div class="form-item required">
                  <label>设计吨位</label>
                  <div class="input-group">
                    <input v-model.number="editForm.designTonnage" type="number" class="form-input" placeholder="请输入数值" required>
              ...
              <div class="form-row">
                <div class="form-item required">
                  <label>设计交付周期要求</label>
                  <input v-model="editForm.deliveryCycle" type="text" class="form-input" placeholder="例如：3-6个月" required>
                </div>
    ...
    <div v-if="toggleConfirmVisible" class="modal-overlay" @click.self="toggleConfirmVisible = false">
      <div class="modal-content small">
        ...
        <div class="modal-body">
          <p>确定要{{ toggleAction === 'offline' ? '下架' : '上架' }}该设计需求吗？</p>
        </div>
        <div class="modal-footer">
...
// 查看详情
const viewDetail = (id) => {
  console.log('[v0] 查看设计需求详情:', id)
  // router.push(`/ship-repair/demand/${id}`)
}

// 编辑需求
const editDemand = (id) => {
  console.log('[v0] 编辑设计需求:', id)
  ...
  editForm.value = {
    ...
    designTonnage: demand.designTonnage,
    navigationArea: demand.navigationArea,
    deliveryCycle: demand.deliveryCycle,
