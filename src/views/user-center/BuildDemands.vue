            ...
            <div class="form-section">
              ...
              <div class="form-row">
                <div class="form-item required">
                  ...
                  <div class="input-group">
                    <input v-model.number="editForm.buildTonnage" type="number" class="form-input" placeholder="请输入数值" required>
              ...
              <div class="form-row">
                <div class="form-item required full-width">
                  ...
                  <textarea v-model="editForm.powerSystem" class="form-textarea" placeholder="请描述动力系统配置要求" rows="3" required></textarea>
                </div>
              </div>
              ...
              <div class="form-row">
                <div class="form-item required">
                  <label>建造交付周期</label>
                  <input v-model="editForm.buildCycle" type="text" class="form-input" placeholder="例如：12-18个月" required>
                </div>

                <div class="form-item required">
                  <label>预算范围</label>
                  <div class="input-group">
                    <input v-model.number="editForm.budgetMin" type="number" class="form-input" placeholder="最小" required>
                    <span class="input-separator">-</span>
                    <input v-model.number="editForm.budgetMax" type="number" class="form-input" placeholder="最大" required>
...
// 跳转到发布页面
const goToPublish = () => {
  router.push('/ship-repair/publish/build')
}
